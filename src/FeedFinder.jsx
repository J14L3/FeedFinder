              ...
              {isLoggedIn ? (
                <>
                  ...
                  <div className="relative" ref={userMenuRef}>
                    ...
                    {showUserMenu && (
                      <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50 animate-slideUp">
                        ...
                        {!isPremium && (
                          <button className="w-full px-4 py-2 text-left hover:bg-gray-100 flex items-center gap-2 text-yellow-600">
                            <Crown size={18} />
                            Upgrade to Premium
                          </button>
                        )}
      ...
      {!isPremium && (
        <div className="bg-gradient-to-r from-yellow-400 to-orange-500 text-white px-4 py-2">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            ...
            <button className="px-4 py-1 bg-white text-orange-600 rounded-full text-sm font-semibold hover:bg-gray-100 transition">
              Learn More
            </button>
          </div>
        </div>
